...
import com.demkom58.lab13.event.EventLogger;
...
public class MainGui extends JFrame {
    private final WoodLock woodLock = new WoodLock();
    ...
    private final Consumer<String> logger = s -> {
        shopHistory.add(s);
        System.out.println(s);
        MainGui.this.updateTextArea();
    };
    ...
    private WasteStore wasteStore = new WasteStore(logger, 3);
    ...
    private final DlgShop dlgShop = new DlgShop(woodDirectory, productStore, woodLock, wasteStore, logger);
    ...
    public synchronized void updateTextArea() {
        ...
        joiner.add(wasteStore.toString());
